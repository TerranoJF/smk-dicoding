...
const formCreateProduct = [
  { name: "name", label: "Nama", type: "text", value: "", placeholder: "Men's Streetwear", required: true },
  ...
  { name: "price", label: "Harga", type: "number", value: "", placeholder: "150000", required: true },
  { name: "image", label: "Gambar", type: "file", value: {}, placeholder: "", required: true },
...
<template>
  <section class="flex justify-center py-10">
    <div class="w-[500px]">
      <h1 class="text-2xl mb-7 font-medium">Tambah Produk</h1>

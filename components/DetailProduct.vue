    ...
    <section class="py-4">
        <div class="container">
            ...
            <NuxtLink to="/product" class="bg-white border border-slate-300 w-max flex
                items-center gap-1 py-2 px-5 rounded-full mb-3 cursor-pointer">
            ...
            <div class="flex items-center">
                ...
                <div class="w-1/2 pl-5">
                    ...
                    <h3 class="text-4xl font-light mb-3">Rp. {{ props.product.price }},00~</h3>
